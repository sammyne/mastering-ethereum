...
- Having no other users means that it doesn't behave the same as a public blockchain. There's no
...
- The JSON-RPC API is an interface that allows us to write programs that use an Ethereum client as a
