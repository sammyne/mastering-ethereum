...
func main() {
	...
	faucetCode, err := generateBinaryABI("Faucet01.sol")
	if err != nil {
		panic(err)
	}
	...
	// deposit some amount for later withdrawal
	tx := types.NewContractCreation(nonce, toWei(1), gasLimit, gasPrice, faucetCode)
